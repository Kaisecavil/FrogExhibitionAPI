        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HouseKeepable = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FrogPhoto", x => x.Id);
                    table.ForeignKey(
                        name: "FK_FrogPhoto_Frogs_FrogId",
                        column: x => x.FrogId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FrogsOnExhibitions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_FrogsOnExhibitions_Exhibitions_ExhibitionId",
                        column: x => x.ExhibitionId,
                        principalTable: "Exhibitions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FrogsOnExhibitions_Frogs_FrogId",
                        column: x => x.FrogId,
                        principalTable: "Frogs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Votes_FrogsOnExhibitions_FrogOnExhibitionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FrogPhoto_FrogId",
                table: "FrogPhoto",
                column: "FrogId");

            migrationBuilder.CreateIndex(
                name: "IX_FrogsOnExhibitions_ExhibitionId",
                table: "FrogsOnExhibitions",
                column: "ExhibitionId");

            migrationBuilder.CreateIndex(
                name: "UniqueFrogId_ExhibitionId",
                table: "FrogsOnExhibitions",
                columns: new[] { "FrogId", "ExhibitionId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Votes_FrogOnExhibitionId",
                table: "Votes",
                column: "FrogOnExhibitionId");

            migrationBuilder.CreateIndex(
                name: "UniqueApplicationUserId_FrogOnExhibitionId",
                table: "Votes",
                columns: new[] { "ApplicationUserId", "FrogOnExhibitionId" },
                unique: true);
        }
